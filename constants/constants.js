export const projects = [
  ...
  },
  {
    ...
    description: "Created a dashboard that uses the OpenWeather API to retrieve weather data for cities that are searched for by user. Uses localStorage to store any cities that have been searched, and allows user to call them up quickly.",
      image: '/images/3.jpg',
      tags: ['HTML', 'CSS', 'JavaScript'],
    source: 'https://lazrekm.github.io/weather-dashboard/',
    visit: 'https://github.com/lazrekm/weather-dashboard',
    id: 2,
  },
  {
    title: 'Website Refactor',
    description: "This project is a code refactor for the Horiseon webpage. The purposes of this refactoring is to optimize SEO, and make make the previous code more comprehensible and accessible.",
    image: '/images/4.jpg',
    tags: ['HTML', 'CSS'],
    source: 'https://lazrekm.github.io/website-refactoring/',
    visit: 'https://github.com/lazrekm/website-refactoring',
    id: 3,
  },
];
